...
public final class Config extends
        ...
        try {
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        DefaultConfig.Builder subBuilder = null;
                        if (default_ != null) {
                            subBuilder = default_.toBuilder();
                        }
                        default_ = input.readMessage(DefaultConfig.parser(), extensionRegistry);
                        if (subBuilder != null) {
                    ...
                    case 26: {
                        DetourConfig.Builder subBuilder = null;
                        if (detour_ != null) {
                            subBuilder = detour_.toBuilder();
                        }
                        detour_ = input.readMessage(DetourConfig.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    internalGetFieldAccessorTable() {
        return ConfigOuterClass.internal_static_v2ray_core_proxy_vmess_inbound_Config_fieldAccessorTable
    ...
    public DefaultConfig getDefault() {
        return default_ == null ? DefaultConfig.getDefaultInstance() : default_;
    }
    ...
    public DetourConfig getDetour() {
        return detour_ == null ? DetourConfig.getDefaultInstance() : detour_;
    }
    ...
    public static final class Builder extends
        ...
        private com.google.protobuf.SingleFieldBuilderV3<
                DefaultConfig, DefaultConfig.Builder, DefaultConfigOrBuilder> defaultBuilder_;
         ...
         * <code>.v2ray.core.proxy.vmess.inbound.DefaultConfig default = 2;</code>
         */
        public Builder setDefault(DefaultConfig value) {
            if (defaultBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public Builder setDefault(
                DefaultConfig.Builder builderForValue) {
            if (defaultBuilder_ == null) {
         ...
         * <code>.v2ray.core.proxy.vmess.inbound.DefaultConfig default = 2;</code>
         */
        public Builder mergeDefault(DefaultConfig value) {
            if (defaultBuilder_ == null) {
                if (default_ != null) {
                    default_ =
                            DefaultConfig.newBuilder(default_).mergeFrom(value).buildPartial();
                } else {
                    default_ = value;
                }
                onChanged();
        ...
        public DefaultConfigOrBuilder getDefaultOrBuilder() {
            if (defaultBuilder_ != null) {
                ...
                return default_ == null ?
                        DefaultConfig.getDefaultInstance() : default_;
            }
        }
         ...
         */
        private com.google.protobuf.SingleFieldBuilderV3<
                DefaultConfig, DefaultConfig.Builder, DefaultConfigOrBuilder>
        ...
        private DetourConfig detour_;
        private com.google.protobuf.SingleFieldBuilderV3<
                DetourConfig, DetourConfig.Builder, DetourConfigOrBuilder> detourBuilder_;
         ...
         * <code>.v2ray.core.proxy.vmess.inbound.DetourConfig detour = 3;</code>
         */
        public Builder setDetour(DetourConfig value) {
            if (detourBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public Builder setDetour(
                DetourConfig.Builder builderForValue) {
            if (detourBuilder_ == null) {
         ...
         * <code>.v2ray.core.proxy.vmess.inbound.DetourConfig detour = 3;</code>
         */
        public Builder mergeDetour(DetourConfig value) {
            if (detourBuilder_ == null) {
                if (detour_ != null) {
                    detour_ =
                            DetourConfig.newBuilder(detour_).mergeFrom(value).buildPartial();
                } else {
                    detour_ = value;
                }
                onChanged();
        ...
        public DetourConfigOrBuilder getDetourOrBuilder() {
            if (detourBuilder_ != null) {
                ...
                return detour_ == null ?
                        DetourConfig.getDefaultInstance() : detour_;
            }
        }
         ...
         */
        private com.google.protobuf.SingleFieldBuilderV3<
                DetourConfig, DetourConfig.Builder, DetourConfigOrBuilder>
