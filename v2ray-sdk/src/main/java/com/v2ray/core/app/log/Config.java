...
public final class Config extends
    ...
    getDescriptor() {
        return ConfigOuterClass.internal_static_v2ray_core_app_log_Config_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return ConfigOuterClass.internal_static_v2ray_core_app_log_Config_fieldAccessorTable
    ...
    public LogType getErrorLogType() {
        ...
        LogType result = LogType.valueOf(errorLogType_);
    ...
    public LogType getAccessLogType() {
        @SuppressWarnings("deprecation")
        LogType result = LogType.valueOf(accessLogType_);
        return result == null ? LogType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (errorLogType_ != LogType.None.getNumber()) {
        ...
        if (accessLogType_ != LogType.None.getNumber()) {
    ...
    public static final class Builder extends
         ...
         * <code>.v2ray.core.app.log.LogType error_log_type = 1;</code>
         */
        public Builder setErrorLogType(LogType value) {
            if (value == null) {
                throw new NullPointerException();
            }
         ...
         * <code>.v2ray.core.app.log.LogType access_log_type = 4;</code>
         */
        public Builder setAccessLogType(LogType value) {
            if (value == null) {
                throw new NullPointerException();
            }
