...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ConfigOuterClass.internal_static_v2ray_core_transport_internet_kcp_ReadBuffer_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ConfigOuterClass.internal_static_v2ray_core_transport_internet_kcp_ReadBuffer_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ReadBuffer.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    ReadBuffer other = (ReadBuffer) obj;
  ...
  public static ReadBuffer parseFrom(
  ...
  public static ReadBuffer parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ReadBuffer parseFrom(
  ...
  public static ReadBuffer parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ReadBuffer parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ReadBuffer parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ReadBuffer prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public ReadBuffer getDefaultInstanceForType() {
      return ReadBuffer.getDefaultInstance();
    }

    @Override
    public ReadBuffer build() {
      ReadBuffer result = buildPartial();
    ...
    @Override
    public ReadBuffer buildPartial() {
      ReadBuffer result = new ReadBuffer(this);
      result.size_ = size_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ReadBuffer) {
        return mergeFrom((ReadBuffer)other);
      } else {
    ...
    public Builder mergeFrom(ReadBuffer other) {
      if (other == ReadBuffer.getDefaultInstance()) return this;
      if (other.getSize() != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ReadBuffer parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ReadBuffer) e.getUnfinishedMessage();
  ...
  private static final ReadBuffer DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ReadBuffer();
  }

  public static ReadBuffer getDefaultInstance() {
