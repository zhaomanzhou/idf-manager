...
public final class Config extends
            ...
            while (!done) {
                ...
                switch (tag) {
                    case 0:
                        ...
                        break;
                    case 10: {
                        SessionConfig.Builder subBuilder = null;
                        if (settings_ != null) {
                            subBuilder = settings_.toBuilder();
                        }
                        settings_ = input.readMessage(SessionConfig.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    getDescriptor() {
        return ConfigOuterClass.internal_static_v2ray_core_app_dispatcher_Config_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return ConfigOuterClass.internal_static_v2ray_core_app_dispatcher_Config_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        Config.class, Builder.class);
    }

    public static final int SETTINGS_FIELD_NUMBER = 1;
    private SessionConfig settings_;
    ...
    public SessionConfig getSettings() {
        return settings_ == null ? SessionConfig.getDefaultInstance() : settings_;
    }

    /**
     * <code>.v2ray.core.app.dispatcher.SessionConfig settings = 1;</code>
     */
    public SessionConfigOrBuilder getSettingsOrBuilder() {
        return getSettings();
    }
    ...
    public static final class Builder extends
        ...
        private com.google.protobuf.SingleFieldBuilderV3<
                SessionConfig, SessionConfig.Builder, SessionConfigOrBuilder> settingsBuilder_;
         ...
         * <code>.v2ray.core.app.dispatcher.SessionConfig settings = 1;</code>
         */
        public Builder setSettings(SessionConfig value) {
            if (settingsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public Builder setSettings(
                SessionConfig.Builder builderForValue) {
            if (settingsBuilder_ == null) {
         ...
         * <code>.v2ray.core.app.dispatcher.SessionConfig settings = 1;</code>
         */
        public Builder mergeSettings(SessionConfig value) {
            if (settingsBuilder_ == null) {
                if (settings_ != null) {
                    settings_ =
                            SessionConfig.newBuilder(settings_).mergeFrom(value).buildPartial();
                } else {
                    settings_ = value;
                }
                onChanged();
         ...
         * <code>.v2ray.core.app.dispatcher.SessionConfig settings = 1;</code>
         */
        public SessionConfig.Builder getSettingsBuilder() {
        ...
        public SessionConfigOrBuilder getSettingsOrBuilder() {
            if (settingsBuilder_ != null) {
                ...
                return settings_ == null ?
                        SessionConfig.getDefaultInstance() : settings_;
            }
        }
         ...
         */
        private com.google.protobuf.SingleFieldBuilderV3<
                SessionConfig, SessionConfig.Builder, SessionConfigOrBuilder>
