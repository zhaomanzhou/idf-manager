...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Config.internal_static_v2ray_core_transport_internet_headers_wechat_VideoConfig_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Config.internal_static_v2ray_core_transport_internet_headers_wechat_VideoConfig_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            VideoConfig.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    VideoConfig other = (VideoConfig) obj;
  ...
  public static VideoConfig parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static VideoConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static VideoConfig parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(VideoConfig prototype) {
  ...
  public static final class Builder extends
    ...
    public VideoConfig build() {
      VideoConfig result = buildPartial();
    ...
    public VideoConfig buildPartial() {
      VideoConfig result = new VideoConfig(this);
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof VideoConfig) {
        return mergeFrom((VideoConfig)other);
      } else {
    ...
    public Builder mergeFrom(VideoConfig other) {
      if (other == VideoConfig.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      VideoConfig parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (VideoConfig) e.getUnfinishedMessage();
