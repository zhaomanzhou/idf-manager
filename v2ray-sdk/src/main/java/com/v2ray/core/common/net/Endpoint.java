...
public final class Endpoint extends
        ...
        try {
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        IPOrDomain.Builder subBuilder = null;
                        if (address_ != null) {
                            subBuilder = address_.toBuilder();
                        }
                        address_ = input.readMessage(IPOrDomain.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    getDescriptor() {
        return Destination.internal_static_v2ray_core_common_net_Endpoint_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return Destination.internal_static_v2ray_core_common_net_Endpoint_fieldAccessorTable
    ...
    public IPOrDomain getAddress() {
        return address_ == null ? IPOrDomain.getDefaultInstance() : address_;
    }
    ...
    public static final class Builder extends
        ...
        private com.google.protobuf.SingleFieldBuilderV3<
                IPOrDomain, IPOrDomain.Builder, IPOrDomainOrBuilder> addressBuilder_;
         ...
         * <code>.v2ray.core.common.net.IPOrDomain address = 2;</code>
         */
        public Builder setAddress(IPOrDomain value) {
            if (addressBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public Builder setAddress(
                IPOrDomain.Builder builderForValue) {
            if (addressBuilder_ == null) {
         ...
         * <code>.v2ray.core.common.net.IPOrDomain address = 2;</code>
         */
        public Builder mergeAddress(IPOrDomain value) {
            if (addressBuilder_ == null) {
                if (address_ != null) {
                    address_ =
                            IPOrDomain.newBuilder(address_).mergeFrom(value).buildPartial();
                } else {
                    address_ = value;
                }
                onChanged();
        ...
        public IPOrDomainOrBuilder getAddressOrBuilder() {
            if (addressBuilder_ != null) {
                ...
                return address_ == null ?
                        IPOrDomain.getDefaultInstance() : address_;
            }
        }
         ...
         */
        private com.google.protobuf.SingleFieldBuilderV3<
                IPOrDomain, IPOrDomain.Builder, IPOrDomainOrBuilder>
